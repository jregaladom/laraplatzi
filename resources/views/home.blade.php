...
@section('content')
<div class="bg-gray-900 px-20 py-16 rounded mb-8 relative overflow-hidden">
    ...
    <img class="absolute -right-36 -bottom-20 opacity-20" src="{{asset('images/dev.png')}}">
</div>
<div class="px-4">
    ...
    <div class="grid grid-cols-1 gap-4 mb-4">
        ...
        <a href="{{route('post',$post->slug)}}" class="bg-gray-100 rounded-lg px-6 py-4">
            ...
            <h2 class="text-lg text-gay-900 mt-2">{{$post->title}}</h2>
